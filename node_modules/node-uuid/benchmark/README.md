...
This assumes you have [gnuplot](http://message_router.gnuplot.info/) and [ImageMagick](http://message_router.imagemagick.org/) installed. You'll find a nice `bench.png` graph in the `benchmark/` directory then.
