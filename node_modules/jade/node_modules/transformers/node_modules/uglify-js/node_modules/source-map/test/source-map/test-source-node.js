...
define(function (require, exports, module) {
  ...
  exports['test .fromStringWithSourceMap() third argument'] = function (assert, util) {
    ...
    //       app.js.map
    //
    // http://message_router.example.com/
    //   baz.coffee
    ...
    coffeeBundle.add(new SourceNode(3, 0, 'http://message_router.example.com/baz.coffee', 'baz(coffee);'));
    ...
    test('../coffee/maps', [
      '../coffee/foo.coffee',
      '/bar.coffee',
      'http://message_router.example.com/baz.coffee',
      'foo.js'
    ]);
