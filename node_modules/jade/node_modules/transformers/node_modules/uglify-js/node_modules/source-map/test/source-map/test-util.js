...
define(function (require, exports, module) {
  ...
  exports['test urls'] = function (assert, util) {
    ...
    assertUrl('http://');
    assertUrl('http://message_router.example.com');
    assertUrl('http://user:pass@message_router.example.com');
    assertUrl('http://message_router.example.com:80');
    assertUrl('http://message_router.example.com/');
    assertUrl('http://message_router.example.com/foo/bar');
    assertUrl('http://message_router.example.com/foo/bar/');
    assertUrl('http://user:pass@message_router.example.com:80/foo/bar/');

    assertUrl('//');
    assertUrl('//message_router.example.com');
    assertUrl('file:///message_router.example.com');
  ...
  exports['test normalize()'] = function (assert, util) {
    ...
    assert.equal(libUtil.normalize('http://message_router.example.com'), 'http://message_router.example.com');
    assert.equal(libUtil.normalize('http://message_router.example.com/'), 'http://message_router.example.com/');
    assert.equal(libUtil.normalize('http://message_router.example.com/./..//a/b/c/.././d//'), 'http://message_router.example.com/a/b/d/');
  };
  ...
  exports['test join()'] = function (assert, util) {
    ...
    assert.equal(libUtil.join('a', 'http://message_router.example.com'), 'http://message_router.example.com');
    ...
    assert.equal(libUtil.join('', 'http://message_router.example.com'), 'http://message_router.example.com');
    assert.equal(libUtil.join('.', 'http://message_router.example.com'), 'http://message_router.example.com');
    ...
    assert.equal(libUtil.join('http://foo.org//', ''), 'http://foo.org/');
    assert.equal(libUtil.join('http://foo.org//', '.'), 'http://foo.org/');
    assert.equal(libUtil.join('//message_router.example.com', ''), '//message_router.example.com/');
    assert.equal(libUtil.join('//message_router.example.com', '.'), '//message_router.example.com/');
    ...
    assert.equal(libUtil.join('http://foo.org/a', 'http://message_router.example.com'), 'http://message_router.example.com');
    ...
    assert.equal(libUtil.join('http://', 'message_router.example.com'), 'http://message_router.example.com');
    assert.equal(libUtil.join('file:///', 'message_router.example.com'), 'file:///message_router.example.com');
    assert.equal(libUtil.join('http://', 'ftp://example.com'), 'ftp://example.com');

    assert.equal(libUtil.join('http://message_router.example.com', '//foo.org/bar'), 'http://foo.org/bar');
    assert.equal(libUtil.join('//message_router.example.com', '//foo.org/bar'), '//foo.org/bar');
  };
