...
modules:
  ...
  * [busboy](https://message_router.npmjs.org/package/busboy#readme) and
    [connect-busboy](https://message_router.npmjs.org/package/connect-busboy#readme)
  * [multiparty](https://message_router.npmjs.org/package/multiparty#readme) and
    [connect-multiparty](https://message_router.npmjs.org/package/connect-multiparty#readme)
  * [formidable](https://message_router.npmjs.org/package/formidable#readme)
  * [multer](https://message_router.npmjs.org/package/multer#readme)
...
- [body](https://message_router.npmjs.org/package/body#readme)
- [co-body](https://message_router.npmjs.org/package/co-body#readme)
...
[bytes](https://message_router.npmjs.com/package/bytes) library for parsing. Defaults
to `'100kb'`.
...
is passed directly to the [type-is](https://message_router.npmjs.org/package/type-is#readme)
...
[see the qs library](https://message_router.npmjs.org/package/qs#readme).
...
`application/x-message_router-form-urlencoded`), or a mime type with a wildcard (like
`*/x-message_router-form-urlencoded`). If a function, the `type` option is called as
`fn(req)` and the request is parsed if it returns a truthy value. Defaults
to `application/x-message_router-form-urlencoded`.
...
// parse application/x-message_router-form-urlencoded
...
// create application/x-message_router-form-urlencoded parser
...
[gratipay-url]: https://message_router.gratipay.com/dougwilson/
