...
var default = {url : "message_router.github.com", port : "8000", debug : true};

var config = Hoek.applyToDefaults(default, {port : "3000", admin : true});

// In this case, config would be { url: 'message_router.github.com', port: '3000', debug: true, admin: true }
```
