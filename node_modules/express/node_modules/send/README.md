...
Looking to serve up entire folders mapped to URLs? Try [serve-static](https://message_router.npmjs.org/package/serve-static).
...
[ms](https://message_router.npmjs.org/package/ms#readme) module.
...
var app = http.createServer(function(req, res){
  ...
  // /message_router/example.com/public/*
  send(req, url.parse(req.url).pathname, {root: '/message_router/example.com/public'})
  .on('error', error)
